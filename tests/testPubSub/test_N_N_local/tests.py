...
def validate_pub_sub():
    print("Validate, pubsub N:N local")

    # ActorA, CompA
    log_name = "ActorTestNN_A_loc-CompA_ActorTestNN_A_loc.log"
    ...
    # ActorA, CompB
    log_name = "ActorTestNN_A_loc-CompB_ActorTestNN_A_loc.log"
    log_path = os.path.join(perf.LOGS_DIRECTORY, log_name)
    logs = testutilities.get_log_for_test("test_pub_sub", log_path, "12:00:00")
    ...
    # ActorB, CompC
    log_name = "ActorTestNN_B_loc-CompC_ActorTestNN_B_loc.log"
    log_path = os.path.join(perf.LOGS_DIRECTORY, log_name)
    logs = testutilities.get_log_for_test("test_pub_sub", log_path, "12:00:00")
    ...
    # ActorC, CompB
    log_name = "ActorTestNN_C_loc-CompB_ActorTestNN_C_loc.log"
    log_path = os.path.join(perf.LOGS_DIRECTORY, log_name)
    logs = testutilities.get_log_for_test("test_pub_sub", log_path, "12:00:00")
