...
setup(name='riaps',
      ...
      scripts = [
        'scripts/riaps_actor',"scripts/riaps-dev.node", "scripts/riaps_ctrl", "scripts/riaps_deplo", "scripts/riaps_disco", "scripts/riaps_lang", "scripts/riaps_depll", "scripts/riaps-dev.ctrl","scripts/sshd.py","scripts/riaps-dev.mn","scripts/riaps_device","riaps_devm"
